...
from PyQt5.QtWidgets import QSlider, QApplication, QWidget, QLabel, QVBoxLayout, QHBoxLayout, QPushButton, QMessageBox, QFileDialog
...
class ConfocalMicroscopy(QWidget):
    ...
    def set_gui(self):
        ...
        # self.shift = QLabeledDoubleSlider(QtCore.Qt.Horizontal)
        # self.shift.setRange(-30, 30)
        # self.shift.setValue(0)
        # self.shift.setSingleStep(1)
        # self.setFocusPolicy(QtCore.Qt.NoFocus)
        # self.shift.valueChanged.connect(self.update_acq_params)
        ...
        # self.rate_label = QLabel("{}".format(self.rate))
        # self.fps_label = QLabel("{:.3f}fps".format(self.rate/self.total_px))
        # layout4.addWidget(self.rate_label)
        # layout4.addWidget(self.srate_slider)
        # layout.addLayout(layout4)

        # layout5 = QHBoxLayout()
        # layout5.addWidget(QLabel("Shift reconstruction arr"))
        # layout5.addWidget(self.shift)
    ...
    def update_acq_params(self):
        ...
        # self.hard_shift = self.shift.value()

        # self.rate = self.srate_slider.value()
        # self.rate_label.setText("{}".format(self.rate))

        # self.fps_label.setText("{:.3f}fps".format(self.rate/self.total_px))
